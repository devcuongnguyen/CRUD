@if ($crud->hasAccess('bulkDelete') && $crud->get('list.bulkActions'))
    <a href="javascript:void(0)" onclick="bulkDeleteEntries(this)" bp-button="bulkDelete"
        class="btn btn-sm btn-secondary bulk-button"><i class="la la-trash"></i>
        <span>{{ trans('backpack::crud.delete') }}</span></a>
@endif
                        ...
                        $.ajax({
                            ...
                            success: function(result) {
                                if (Array.isArray(result)) {
                                    ...
                                    new Noty({
                                        type: "success",
                                        text: "<strong>{!! trans('backpack::crud.bulk_delete_sucess_title') !!}</strong><br>" +
                                            crud.checkedItems.length + "{!! trans('backpack::crud.bulk_delete_sucess_message') !!}"
                                    }).show();
                                } else {
